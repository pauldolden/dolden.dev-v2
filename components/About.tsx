...
export const About = forwardRef((props: Props, ref) => {
      ...
      {inView && (
        ...
        >
          ...
          <div className="mt-16 space-y-4 sm:mt-16 sm:space-y-0 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 grid grid-cols-3">
            <div className="bg-background col-span-2 text-white text-xl font-medium mr-4 ">
              <h3 className="font-extrabold text-3xl">The Personal Stuff</h3>
              <p className="mt-4">
                Hello, I'm Paul. A developer from Essex, UK. I enjoy lots of
                things, but do very few of them. Mostly I just code and hang out
                with my wife, kid and dog. I learned to code by accident, it was
                pretty cool. Before that I was writing regular old prose. I
                still need to finish that novel...
              </p>
              <p className="mt-4">
                I'm currently employed as a React Native developer at 2D Media,
                in Witham, Essex, working on bespoke mobile applications. My
                passion, however, remains the web.
              </p>
              <div className="mt-4">
